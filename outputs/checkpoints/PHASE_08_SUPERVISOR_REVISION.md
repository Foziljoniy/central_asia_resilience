...
## 4. Word-count change
The clean v2 main text contains 6642 words, excluding references.

## 5. Literature expansion
The verified manuscript literature matrix contains 20 sources.
...
Funding; conflicts of interest; ethics statement; data availability; code availability; author contributions; acknowledgements; target journal; AI-use disclosure wording.

## 16. Submission blockers
Funding, conflicts of interest, ethics statement, data availability, code availability, author contributions, acknowledgements, target-journal formatting and AI-use disclosure wording remain unresolved. The Uzbekistan-specific literature gap is documented internally but no public placeholder remains in the manuscript.
