...
\newcommand{\orcidlink}[1]{%
  \href{https://orcid.org/#1}{\textsuperscript{\textcolor{green!50!black}{\scriptsize\bfseries iD}}}%
}
...
\vspace{1.3em}
{\large\bfseries
Foziljon Alisherov\textsuperscript{1}\orcidlink{0009-0004-9451-0518}
and
Mukhayyo Djuraeva\textsuperscript{1}\orcidlink{0000-0001-6163-7513}
\par}

\vspace{0.7em}
{\normalsize\textsuperscript{1}\textit{New Uzbekistan University}\par}

\vspace{0.55em}
{\normalsize Foziljon Alisherov: Research Assistant and final-year student\par}
{\normalsize Mukhayyo Djuraeva: Professor,
\href{https://www.newuu.uz/en/employee/view/faculty-members/419}{New Uzbekistan University profile}\par}

\vspace{0.55em}
{\normalsize Emails:
\href{mailto:f.alisherov@newuu.uz}{f.alisherov@newuu.uz};
\href{mailto:m.djuraeva@newuu.uz}{m.djuraeva@newuu.uz}\par}
...
\noindent\textbf{JEL classification:} F24; I32; O15
